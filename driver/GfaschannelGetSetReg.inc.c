 ...
 * @return OK     - success
 */
static int assert_rbounds(GFASCHANNELStatics_t *s, int crwb,
 ...
 * @return OK     - success
 */
static int assert_wbounds(GFASCHANNELStatics_t *s, int crwb,
			  char **uaddr, int size, char **back)
{
#ifdef __Lynx__
	if (crwb) {
 ...
 * @return OK     - success
 */
static int end_read(GFASCHANNELStatics_t *s, char *kaddr,
		    int size, char *uaddr)
{
	int cc = OK;
#ifdef __linux__
 ...
 * @return OK
 */
static int end_write(GFASCHANNELStatics_t *s, char *kaddr)
{
#ifdef __linux__
	sysfree(kaddr, 0);
#endif
...
int get_##_r_nm(register GFASCHANNELStatics_t *s, char *ioctlarg,	\
		int crwb, int r_rw)					\
{									\
...
int set_##_r_nm(register GFASCHANNELStatics_t *s, char *ioctlarg,	\
		int crwb, int r_rw)					\
{									\
...
int get_##_blk_idx##_##_r_nm(register GFASCHANNELStatics_t *s, char *ioctlarg, \
			     int crwb, int r_rw)			\
{									\
...
int get_##_blk_idx##_##_r_nm(register GFASCHANNELStatics_t *s,		\
...
int set_##_blk_idx##_##_r_nm(register GFASCHANNELStatics_t *s,		\
			     char *ioctlarg, int crwb, int r_rw)	\
{									\
 ...
 * @return OK     - otherwise
 */
int get___SRV__DEBUG_FLAG(register GFASCHANNELStatics_t *s,
 ...
 * @return OK     - otherwise
 */
int set___SRV__DEBUG_FLAG(register GFASCHANNELStatics_t *s,
			  char *uaddr, int crwb, int r_rw)
{
	char *uaddr_back; /* backup user-space address */
 ...
 * @return OK     - otherwise
 */
int get___SRV__DEVINFO_T(register GFASCHANNELStatics_t *s,
			 char *uaddr, int crwb, int r_rw)
{
	char *uaddr_back; /* backup user-space address */
 ...
 * @return OK     - otherwise
 */
int get___SRV__DRVR_VERS(register GFASCHANNELStatics_t *s,
			 char *ioctlarg, int crwb, int r_rw)
{
 ...
 * @return OK     - otherwise
 */
int get___SRV__DAL_CONSISTENT(register GFASCHANNELStatics_t *s,
			      char *uaddr, int crwb, int r_rw)
{
	char *uaddr_back; /* backup user-space address */
	...
	*(unsigned long*)uaddr = GFASCHANNEL_GENERATION_TIME_HEX;
...
/**
 * @brief Vector sequence for function1
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS1, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function2
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS2, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function3
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS3, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function4
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS4, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function5
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS5, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function6
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS6, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function7
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS7, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function8
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS8, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function9
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS9, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function10
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS10, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function11
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS11, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function12
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS12, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function13
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS13, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function14
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS14, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function15
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS15, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function16
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS16, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function17
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS17, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function18
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS18, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function19
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS19, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function20
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS20, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function21
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS21, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function22
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS22, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function23
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS23, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function24
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS24, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function25
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS25, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function26
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS26, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function27
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS27, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function28
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS28, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function29
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS29, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function30
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS30, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function31
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS31, short, 0, block00, w, 16);

/**
 * @brief Vector sequence for function32
 *
 * This is a Normal register.
 */
RW_REG_ARR(VECTORS32, short, 0, block00, w, 16);

/**
 * @brief Mask of functions to be converted (bit map)
 *
 * This is a Normal register.
 */
RW_REG_ARR(FUNC_CONVERT, short, 0, block01, w, 16);

/**
 * @brief Number of the function to be generated (selected)
 *
 * This is a Normal register.
 */
RW_REG_SCAL(FUNC_SELECT, short, 0, block01, w, 16);

/**
 * @brief Mode [Normal/DAC/Low Jitter/Recurrent/Low Jitter Recurrent/Test1/Test2/No Func]
 *
 * This is a Normal register.
 */
RW_REG_SCAL(CONFIG, short, 0, block01, w, 16);
 ...
 * This is a Normal register.
 */
RW_REG_SCAL(SLOPE, short, 0, block01, w, 16);

/**
 * @brief DAC value [0: -10V, 65535: +10V]
 *
 * This is a Normal register.
 */
RW_REG_SCAL(DAC_VAL, short, 0, block01, w, 16);

/**
 * @brief Number of recurrent cycles (signed)
 *
 * This is a Normal register.
 */
RW_REG_SCAL(RECURR_CYCLES, short, 0, block01, w, 16);

/**
 * @brief Mask of functions to be disabled (bit map)
 *
 * This is a Normal register.
 */
RW_REG_ARR(FUNC_DISABLE, short, 0, block01, w, 16);

/**
 * @brief Force conversions (boolean)
 *
 * This is a Normal register.
 */
RW_REG_SCAL(FORCE_CONVERT, short, 0, block02, w, 16);

/**
 * @brief Convert functions (boolean)
 *
 * This is a Normal register.
 */
RW_REG_SCAL(CONVERT_FUNC, short, 0, block02, w, 16);

/**
 * @brief Select function (boolean)
 *
 * This is a Normal register.
 */
RW_REG_SCAL(SELECT_FUNC, short, 0, block02, w, 16);

/**
 * @brief Soft main start (boolean)
 *
 * This is a Normal register.
 */
RW_REG_SCAL(SOFT_START, short, 0, block02, w, 16);

/**
 * @brief Soft event start (boolean)
 *
 * This is a Normal register.
 */
RW_REG_SCAL(SOFT_EV_START, short, 0, block02, w, 16);

/**
 * @brief Accepted functions (bit map)
 *
 * This is a Normal register.
 */
RO_REG_ARR(ACCEPT_STATUS, short, 0, block03, w, 16);

/**
 * @brief Status (bit map)
 *
 * This is a Normal register.
 */
RO_REG_SCAL(STATUS, short, 0, block03, w, 16);

/**
 * @brief Disabled functions (bit map)
 *
 * This is a Normal register.
 */
RO_REG_ARR(DISABLE_STATUS, short, 0, block03, w, 16);

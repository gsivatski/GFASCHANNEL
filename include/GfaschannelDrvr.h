#ifndef _GFASCHANNEL_DRVR_H_INCLUDE_
#define _GFASCHANNEL_DRVR_H_INCLUDE_
...
} __attribute__((packed)) GFASCHANNELBlock00_t;
...
} __attribute__((packed)) GFASCHANNELBlock01_t;
...
} __attribute__((packed)) GFASCHANNELBlock02_t;
...
} __attribute__((packed)) GFASCHANNELBlock03_t;
...
#endif /* _GFASCHANNEL_DRVR_H_INCLUDE_ */
